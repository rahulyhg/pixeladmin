            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <p>Pixel Admin is a popular open source WebApp template for admin dashboards and control panels. It is a responsive HTML template that is based on the CSS framework Bootstrap 3.3.6 It utilizes all of the Bootstrap components in its design and re-styles many commonly used plugins to create a consistent design that can be used as a user interface for backend applications. Pixel Admin is based on a modular design, which allows it to be easily customized and built upon. This documentation will guide you through installing the template and exploring the various components that are bundled with the template.</p>
                        <hr>
...
&lt;head&gt;
	...
	&lt;meta name="author" content=""&gt;
	&lt;link rel="icon" type="image/png" sizes="16x16" href="../plugins/images/favicon.png"&gt;
	&lt;title&gt;Pixel Admin - is a responsive admin template&lt;/title&gt;
...
&lt;/div&gt;</pre>
                        <hr> <img src="../plugins/images/pixel-header.jpg" class="img-responsive" />
                        <h3 class="box-title m-t-10">Logo (in <code>php/header.php</code>)</h3>
                        <p>You can find below code in <code>header.php</code> file and it is used for (pixeladmin-inverse-php) logo. you can change it by text or image or icon, if your image height is bigger then 60px, you need to resize your logo or give height="60" to your logo image.</p> <pre class="prettyprint">
&lt;!-- Logo --&gt;
	&lt;a class="logo" href="index.html"&gt;
		...
		&lt;img src="../plugins/images/pixeladmin-logo.png" alt="home" class="dark-logo" /&gt;

		&lt;!--This is light logo icon--&gt;
		&lt;img src="../plugins/images/pixeladmin-logo-dark.png" alt="home" class="light-logo" /&gt; &lt;/b&gt;

		&lt;!-- Logo text image you can use text also --&gt;
		&lt;span class="hidden-xs"&gt;

		&lt;!--This is dark logo text--&gt;
		&lt;img src="../plugins/images/pixeladmin-text.png" alt="home" class="dark-logo" /&gt;

		&lt;!--This is light logo text--&gt;
		&lt;img src="../plugins/images/pixeladmin-text-dark.png" alt="home" class="light-logo" /&gt; &lt;/span&gt; 
	&lt;/a&gt;
	    ...
	    &lt;!-- Left navbar-header --&gt;
	         ...
	         &lt;!-- Left navbar-header end --&gt;
                            ...
                            <div class="col-md-4 col-sm-4"><img src="../plugins/images/pixel-l-sdebar.jpg" alt="sidebar" /></div>
                        </div>
                        <hr>
...
&lt;!-- /.right-sidebar --&gt;</pre>
                        ...
                        <p>Below code is used for footer in all pages and you can find this code in <code>footer.php</code> file.</p> <pre class="prettyprint">&lt;footer class="footer text-center"&gt; 2016 &copy; Pixel Admin brought to you by themedesigner.in &lt;/footer&gt;
                        </pre>
                        <hr>
...
responsive.less( this less include for responsive layout of the template)
                        ...
                        <div class="alert alert-info"> Note: we recomonded you to please make your one own css and one own js files and add that in your page, so whenever the update of pixeladmin comes it does not affect your code. </div>
                        <hr>
                        ...
                        <p>we make classes to help you in your developement process, and make it fast. checkout the below link for the helper classes</p> <a href="http://wrappixel.com/demos/admin-template/pixeladmin/inverse/utility-classes.html" target="_blank" class="btn btn-success btn-rounded">click for the Utility Classes</a>
                        <hr>
                        <div class="clear"></div>
                    </div>
                </div>
               ...
               &lt;body&gt;
                  ...
                  &lt;div class="navbar-default sidebar slimscroll"&gt; &lt;/div&gt;
                   ...
                   <span style="color:#ccc;">&lt;!-- Main Content --&gt;</span>
                    ...
                    &lt;footer class="footer text-center"&gt; 2016 © Pixeladmin brought to you by themedesigner.in &lt;/footer&gt;
