                ...
                <div class="col-md-12 col-lg-12 col-xs-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-xs-6"><span class="pie" data-peity='{ "fill": ["#3e4d6c", "#f2f2f2"]}'>0.52,1.041</span>
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-xs-6"><span class="donut" data-peity='{ "fill": ["#3e4d6c", "#f2f2f2"], "innerRadius": 8, "radius": 32 }'>0.52,1.041</span>
                                <div>Data : 0.52, 1.041</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-6"><span class="peity-bar" data-peity='{ "fill": ["#3e4d6c", "#99d683"]}' data-width="100%" data-height="60">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
